...
function renderSiteFooter() {
  ...
  const facebookQuote = encodeURIComponent('IT1-CODE-POCKET | 情報Ⅰ 第3問対策');
  const shareLinks = isTopPage
    ? `
      <div class="site-footer-share" aria-label="SNSで共有">
        ...
        <a class="site-footer-share-btn share-facebook" href="https://www.facebook.com/sharer/sharer.php?u=${shareUrl}&quote=${facebookQuote}" target="_blank" rel="noopener noreferrer">Facebook</a>
      </div>
    `
    : '';
